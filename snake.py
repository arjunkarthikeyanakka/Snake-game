...
class Game:
    ...
    def game_paused(self):
        self.render_background()
        font = pygame.font.SysFont('arial', 30)
        line1 = font.render(f"Game is paused! Your score is {self.snake.length-1}, press space bar to "
                            f"continue your game", True, (255, 255, 255))
    ...
    def run(self):
            ...
            for event in pygame.event.get():
                if event.type == KEYDOWN:
                    ...
                    if event.key == K_SPACE:
                        self.pause_counter = 1-self.pause_counter
        ...
        print("Your score is : ",self.snake.length)
